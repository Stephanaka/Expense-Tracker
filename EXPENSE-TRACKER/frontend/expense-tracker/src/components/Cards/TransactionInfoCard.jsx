...
import { translateCategory, translateSource } from "../../utils/helper";

// Transaction card component - Displays individual transaction with icon, date, amount, and delete button
            ...
            <div className="flex-1 flex items-center justify-between">
                <div>
                    <p className="text-sm text-gray-700 font-medium">
                        {type === "income" ? translateSource(title) : translateCategory(title)}
                    </p>
